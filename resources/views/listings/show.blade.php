    ...
    <div class="mx-4">
        <x-card class="p-10">
            ...
            <div class="flex flex-col items-center justify-center text-center">
                ...
                <x-listing-tags :tagsCsv="$listing->tags" /> {{--listing-tags component used here--}}
                ...
                <div>
                    ...
                    <div class="text-lg space-y-6">
                        ...
                        <a href="https:{{$listing->website}}" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80">
        ...
        {{-- <x-card class="mt-4 p-2 flex space-x-6">
            <a href="/listings/{{$listing->id}}/edit" class="">
