    ...
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        ...
        <form action="/listings/{{$listing->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10" placeholder="Include tasks, requirements, salary, etc" value="{{$listing->description}}"
