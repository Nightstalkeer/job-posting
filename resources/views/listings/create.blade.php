    ...
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        ...
        <form action="/listings" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10" placeholder="Include tasks, requirements, salary, etc" value="{{old('description')}}"
                ></textarea>
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                @enderror
